...
```{r, eval = FALSE}
## DO NOT RUN
# use cross validation to assess neighbors
...
```{r}
# visualize results, plot cv results for parameter tuning
...
```{r}
# find best from knn cv based on the area under the curve metric
show_best(knn_cv_tune, n = 1, metric = "roc_auc")

knn_final <- finalize_workflow(knn_workflow, select_best(knn_cv_tune, metric = "roc_auc"))
