...
- Our data appear to have two distinct groups where price falls under 25 dollars per bushel and around $75 dollars per bushel. Additionally, pumpkins seem to be sold mostly on certain days of the year, with distinct regular gaps between sales.
...
new_pumpkins %>%
  ...
  labs(y = "price ($)",
       x = "month",
       title = "Average Pumpkin Sale Price by Month")
```
