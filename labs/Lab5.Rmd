...
# specify our recipe
# different recipe for k-nearest neighbors versus the others?
# what to do about song name (character)?
knn_rec <- recipe(owner ~ ., data = music_train) %>% 
  step_normalize(all_numeric_predictors()) %>% 
  prep()

baked_train <- bake(knn_rec, music_train)
```
