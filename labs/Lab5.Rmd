...
Sys.setenv(SPOTIFY_CLIENT_ID = 'e4e7f9897b354299b562db238402752c') 
Sys.setenv(SPOTIFY_CLIENT_SECRET = '7210f5cb01bd4cdba89952e69f4e3745')
...
```{r}
# get top 50 tracks
spotifyr::get_my_top_artists_or_tracks(type = "tracks", 
