...
cvs_model1 <- caret::train(yr1status ~ CVS_percent, data = trees_train, method = "glm",
                           family = "binomial", trControl = control)

cvs_model2 <- caret::train(yr1status ~ BCHM_m, data = trees_train, method = "glm",
                           family = "binomial", trControl = control)
```
...
```{r}
resamps <- caret::resamples(list(cvs_model1, cvs_model2))
